...
public class Dashboard extends CommonFunctionsWeb {
    ...
    public static By selectLocation = By.xpath("//button[text()='Select 57 Locations' and contains(@class, 'bg-udc_blue_800')]");
    ...
    public static By ViewLocationDateFilter = By.xpath("//button[contains(@class,'text-udc_blue_800') and normalize-space(.)='Today, 4 Aug']");


    public static By ViewLocationYearButton = By.xpath("//button[normalize-space(text())='Year' and contains(@class,'bg-[#EAF3FF]')]");
